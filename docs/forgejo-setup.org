...
** Phase 3: Forgejo git server
*** 1. Installation and directory setup
#+begin_src sh
...
*** 2. Config: =sudo nano /etc/forgejo/app.ini=
#+begin_src ini
[server]
...
*** 3. Service: =sudo nano /etc/systemd/system/forgejo.service=
#+begin_src ini
[Unit]
...
*** 1. Install a custom Caddy (DNS-01)
#+begin_src sh
...
** Phase 6: active defence (fail2ban)
...
** Phase 7: backups and automation
