---
description: "Capture the current context (a thing just explained, debugged, or learned) as a durable Knowledge Base note in the Obsidian vault at $OBSIDIAN_VAULT. Use when the user says 'add this to my notes / knowledge base / second brain' or wants to remember an explanation for later."
---
...
1. **Decide the subject** from `$ARGUMENTS` if given, else from the recent conversation/context
   (the thing just explained, debugged, or learned).
